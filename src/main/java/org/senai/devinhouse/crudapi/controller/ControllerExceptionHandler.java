...
public class ControllerExceptionHandler {
    ...
    /**
     * O @ExceptionHandler informa qual a exceção tratada aqui, e o corpo da
     * requisição
    ...
    /**
     * Aqui, valida-se as mensagens do Bean Validation, recuperando cada mensagem e
     * adicionando-as na lista.
     */
